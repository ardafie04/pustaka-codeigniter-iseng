            ...
            <a class="navbar-brand" href="<?= base_url(); ?>">Pustaka Booking</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        <a class="nav-item nav-link active" href="<?= base_url('home'); ?>"><i class="fas fw fa-home"></i> Beranda <span class="sronly"></span></a>
                            <?php
                            if (!empty($this->session->userdata('email'))) { ?>
                            <a class="nav-item nav-link" href="<?= base_url('booking'); ?>"><i class="fas fw fa-book"></i> Booking <b><?= $this->Booking_model->getDataWhere('temp', ['email_user' => $this->session->userdata('email')])->num_rows(); ?></b> Buku</a>
                            <a class="nav-item nav-link" href="<?= base_url('member/myprofil'); ?>"><i class="fas fw fa-user"></i> Profil Saya</a>
